...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.  providing access to the match object, it makes the closest copy/match of a component. it is used to create nested paths.
1. How would you explain form validation to someone who has never programmed before?
making sure the information being entered is correct before it gets to its final destination.
1. In 1-2 sentences, define end to end testing. testing an application from start to finish. or every step of the way.
